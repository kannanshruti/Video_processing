function var_res = variable_thres_1(img_a, img_b, sigma_ratio, T, variance_s, theta)

% Function: Returns the frame on which Variable thresholding of the first order has been done
% Inputs: 
%   img_a: Frame Tk-1
%   img_b: Frame Tk
...
%   var_res: Image with variable thresholding performed
    ...
    for iter = 1:3
        for i = 1:rows
            for j = 1:cols
                [Qs, Qm] = neighbours(4, var_res, i, j, rows, cols);
