...
% Description:
% Input:
%        img1, img2: Images for which blokc motion is being estimated
%        rows, cols: Size of the image
%        N: Block size
%        D: Search range
%        error_fcn: Error funtion to find out where each block has moved
% Output: 
%        min_d: Stores block start row, col; min error 'd' values; new centers; end row,col of block
%        vector_field: Stores more coordinates in the block for plotting the vector field
%        fig: Generates the vector field figure
